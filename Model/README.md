...
# API server
python app_integration/model_bridge.py --host 0.0.0.0 --port 8000
...
## 1 Collect data (pick one of these):
python scripts/collect_data.py
or
python scripts/collect_specific_signs.py
## 2 Prepare data:
...
4. Push to the branch
5. Create a Pull Request
>>>>>>> 2b0e417efa5934465f2671c2e3bde17cd68f062a
